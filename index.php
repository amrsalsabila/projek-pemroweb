...
<body>
	...
	<header>
		...
		<div class="jumbotron jumbotron-fluid transparent m-0">
		  <div class="container">
		    <h1 class="display-4">Ruang Baca</h1>
		    <p class="lead">Disini kita membaca dengan senang hati!</p>
		  </div>
		</div>
	...
	<main>
		<div class="container-fluid bg-white p-5">
			<h1 class="text-center text-dark m-4">Explore Our Collections</h1>
	...
	<div class="index-about">
		<div class="transparent">
			<div class="container p-4 center">
				...
				<a href="about.php">
					<button type="button" class="btn btn-success text-white">About</button>
				</a>
			</div>
		</div>
	</div>
